                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="travel-label" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select class="select2_group form-control">
                            <optgroup label="Continent">
                              <option value="AK">Pays</option>
                              <option value="HI">Pays</option>
                              <option value="HI">Pays</option>
                            </optgroup>
                            <optgroup label="Continent">
                              <option value="AK">Pays</option>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select class="select2_group form-control">
                            <optgroup label="Pays">
                              <option value="AK">Ville</option>
                              <option value="HI">Ville</option>
                              <option value="HI">Ville</option>
                            </optgroup>
                          </select>
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="date-begin" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="date-end" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
