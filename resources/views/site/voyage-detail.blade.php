								...
								<div class="wrap-division">
									...
									<div class="row">
											...
											<div class="room-wrap">
												<div class="row">
													<div class="col-md-6 col-sm-6">
														<div class="room-img" style="background-image: url({{$voyage->photo}});"></div>
													</div>
													<div class="col-md-6 col-sm-6">
														<div class="desc">
															<span class="day-tour">{{$voyage->cout}} € / {{$voyage->duree}} Days</span>
															<h2>{{$voyage->ville}}, {{$voyage->pays}}</h2>
										...
										<div class="col-md-12 animate-box text-center">
                                            @if ($voyage->disponibilite == 1)
                                                <p>Voyage Disponible !</p>
                                            @else
                                                <p>Voyage non Disponible.</p>
                                            @endif
